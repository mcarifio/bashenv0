...
_me=$(realpath --strip --quiet ${BASH_SOURCE})
_here=$(dirname ${_me})
_name=$(basename ${_me})
...
_start() {
    ...
    local media=/tank/mcarifio/media/Music
    local whitenoise=${media}/whitenoise/calming-seas-11h.ogg 
    [[ -f ${whitenoise} ]] && cvlc --quiet ${whitenoise} &
